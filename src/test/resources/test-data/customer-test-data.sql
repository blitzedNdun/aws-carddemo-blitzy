...
-- Insert test customers (using corrected column names matching account.entity.Customer)
INSERT INTO PUBLIC.customers (customer_id, first_name, middle_name, last_name, ssn, government_issued_id, date_of_birth, fico_credit_score, primary_card_holder_indicator, phone_home, address_line_1, address_state, address_zip, address_country) VALUES
('100000001', 'John', 'M', 'Smith', '123456789', 'DL-CA-123456789', '1980-01-15', 750, 'Y', '555-0101', '123 Main St', 'CA', '10001', 'USA'),
