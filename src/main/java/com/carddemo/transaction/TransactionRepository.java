...
public interface TransactionRepository extends JpaRepository<Transaction, String> {
     ...
     */
    @Query("SELECT COALESCE(SUM(CASE WHEN t.transactionType IN (com.carddemo.common.enums.TransactionType.PU, com.carddemo.common.enums.TransactionType.ON, com.carddemo.common.enums.TransactionType.RP, com.carddemo.common.enums.TransactionType.CA, com.carddemo.common.enums.TransactionType.CB, com.carddemo.common.enums.TransactionType.AF, com.carddemo.common.enums.TransactionType.LF, com.carddemo.common.enums.TransactionType.OF, com.carddemo.common.enums.TransactionType.IN, com.carddemo.common.enums.TransactionType.BT) THEN t.amount ELSE -t.amount END), 0) FROM Transaction t WHERE t.account.accountId = :accountId AND t.categoryCode = :transactionCategory")
     ...
     */
    @Query("SELECT COALESCE(SUM(CASE WHEN t.transactionType IN (com.carddemo.common.enums.TransactionType.PU, com.carddemo.common.enums.TransactionType.ON, com.carddemo.common.enums.TransactionType.RP, com.carddemo.common.enums.TransactionType.CA, com.carddemo.common.enums.TransactionType.CB, com.carddemo.common.enums.TransactionType.AF, com.carddemo.common.enums.TransactionType.LF, com.carddemo.common.enums.TransactionType.OF, com.carddemo.common.enums.TransactionType.IN, com.carddemo.common.enums.TransactionType.BT) THEN t.amount ELSE -t.amount END), 0) FROM Transaction t WHERE t.account.accountId = :accountId AND t.processingTimestamp >= :startDate AND t.processingTimestamp <= :endDate")
