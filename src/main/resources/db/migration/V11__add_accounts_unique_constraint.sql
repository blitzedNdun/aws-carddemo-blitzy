/*
 * V11__add_accounts_unique_constraint.sql
 * 
 * CardDemo Database Migration Script V11
 * 
 ...
 * CONSTRAINT fk_cards_account FOREIGN KEY (account_id, customer_id) REFERENCES accounts(account_id, customer_id)
 * 
 * Business Logic:
 ...
 * 
 * Author: Blitzy agent
 * Created: Database constraint migration for foreign key support
 * Version: 1.0 - Unique constraint addition for accounts table
 * =============================================================================
 */

-- Add unique constraint on account_id and customer_id combination
-- This constraint is required for foreign key references from cards table
