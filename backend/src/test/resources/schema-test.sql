...
CREATE INDEX IF NOT EXISTS idx_authorization_card ON authorization(card_number);
CREATE INDEX IF NOT EXISTS idx_authorization_account ON authorization(account_id);
CREATE INDEX IF NOT EXISTS idx_closure_account ON account_closure(account_id);

-- Insert reference data for transaction types
INSERT INTO transaction_types (type_code, type_description, debit_credit_flag) VALUES
('01', 'Purchase', 'D'),
('02', 'Cash Advance', 'D'),
('03', 'Payment', 'C'),
...
INSERT INTO transaction_categories (category_code, subcategory_code, category_description, category_name, transaction_type_code) VALUES
...
INSERT INTO system_configuration (config_category, config_key, config_value, description, data_type) VALUES
