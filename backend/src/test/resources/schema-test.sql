...
-- Statement table - maps to Statement entity
CREATE TABLE IF NOT EXISTS statement (
    ...
    finance_charge DECIMAL(15,2) DEFAULT 0.00,
...
CREATE INDEX IF NOT EXISTS idx_transaction_account ON transaction_data(account_id);
CREATE INDEX IF NOT EXISTS idx_transaction_date ON transaction_data(transaction_date);
...
CREATE INDEX IF NOT EXISTS idx_statement_account ON statement(account_id);
...
CREATE INDEX IF NOT EXISTS idx_dispute_account ON dispute(account_id);
...
ALTER TABLE transaction_data DROP CONSTRAINT IF EXISTS fk_transaction_account;
ALTER TABLE transaction_data DROP CONSTRAINT IF EXISTS fk_transaction_card;
ALTER TABLE transaction_data DROP CONSTRAINT IF EXISTS fk_transaction_type;
ALTER TABLE transaction_data DROP CONSTRAINT IF EXISTS fk_transaction_category;

ALTER TABLE transaction_data ADD CONSTRAINT fk_transaction_account 
    FOREIGN KEY (account_id) REFERENCES account_data(account_id);
ALTER TABLE transaction_data ADD CONSTRAINT fk_transaction_card 
    FOREIGN KEY (card_number) REFERENCES card_data(card_number);
ALTER TABLE transaction_data ADD CONSTRAINT fk_transaction_type 
    FOREIGN KEY (type_code) REFERENCES transaction_types(type_code);
ALTER TABLE transaction_data ADD CONSTRAINT fk_transaction_category 
...
MERGE INTO transaction_types (type_code, type_description, debit_credit_flag) KEY(type_code) VALUES
('01', 'Purchase', 'D'),
('02', 'Cash Advance', 'D'),
('03', 'Payment', 'C'),
