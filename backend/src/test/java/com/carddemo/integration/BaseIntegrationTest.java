...
public abstract class BaseIntegrationTest extends AbstractBaseTest {
    ...
    public Account createTestAccount() {
        return super.createTestAccount()
                .toBuilder()
                ...
                .availableCredit(new BigDecimal("3500.00").setScale(TestConstants.COBOL_DECIMAL_SCALE, TestConstants.COBOL_ROUNDING_MODE))
    ...
    public Transaction createTestTransaction() {
        return super.createTestTransaction()
                .toBuilder()
                .transactionId(TestConstants.TEST_TRANSACTION_ID)
                .accountId(TestConstants.TEST_ACCOUNT_ID)
    ...
    public UserSecurity createTestUser() {
        return UserSecurity.builder()
                .secUsrId(TestConstants.TEST_USER_ID)
                .username("testuser")
                .password("$2a$10$encrypted.password.hash") // BCrypt hash for "password123"
                .firstName("Test")
                .lastName("User")
                .secUsrType("U") // Regular user
                .build();
    }
    ...
    public void assertBigDecimalEquals(BigDecimal expected, BigDecimal actual) {
        super.assertBigDecimalEquals(expected, actual);
    }
