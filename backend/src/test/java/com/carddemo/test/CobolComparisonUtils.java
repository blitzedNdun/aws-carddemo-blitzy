...
public class CobolComparisonUtils {
     ...
     */
    public static void validateFicoScorePrecision(BigDecimal cobolFicoScore, BigDecimal javaFicoScore, String customerId) {
        ...
        assertThat(javaFicoScore)
            .withFailMessage("FICO score precision validation failed for customer %s: COBOL=%s, Java=%s", 
        ...
        assertThat(cobolFicoScore.intValue())
            .withFailMessage("COBOL FICO score out of valid range for customer %s: %s", 
                customerId, cobolFicoScore)
            .isBetween(300, 850);
            
        assertThat(javaFicoScore.intValue())
            .withFailMessage("Java FICO score out of valid range for customer %s: %s", 
